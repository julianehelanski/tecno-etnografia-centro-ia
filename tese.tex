...
% Força a numeração arábica (1, 2, 3...) desde a primeira página
...
%%% FICHA CATALOGRÁFICA
\includepdf[pagecommand={\thispagestyle{plain}}]{ficha-catalografica}

%%% FOLHA DE APROVAÇÃO
\includepdf[pagecommand={\thispagestyle{plain}}]{folha-de-aprovacao}
