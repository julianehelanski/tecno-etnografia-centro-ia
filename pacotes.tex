...
\usepackage{fontawesome5}   % ícone \faYoutube
\usepackage{hyperref}       % carregue por último

% cores
\definecolor{latexneon}{HTML}{0A84FF}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\AtBeginDocument{
  % Desativa cabeçalhos/rodapés nas páginas pré-textuais
  \pagestyle{empty}
  % DESATIVA as âncoras de página para evitar duplicatas e corrigir os links da bibliografia
  \hypersetup{pageanchor=false}
}

% Comando customizado para colocar exatamente no início da Apresentação (Cap. 0)
\newcommand{\iniciarParteTextual}{%
  \clearpage
  % REATIVA as âncoras do hyperref ANTES de reiniciar a paginação
  \hypersetup{pageanchor=true}
  \pagestyle{fancy}           % Ativa o cabeçalho configurado (número no canto direito)
  \pagenumbering{arabic}      % Transforma a numeração em arábica e reseta automaticamente para 1
}